...
void usercontrol(void) {
  ...
  while (true) {
    ...
    if (Controller1.Axis2.position(percent) > 10) {
      if (Controller1.Axis2.position(percent) > 60) {
        flywheelSpeed = flywheelSpeed + 10;
      } else {
        flywheelSpeed = flywheelSpeed + 5;
      }
      waitUntil(Controller1.Axis2.position(percent) < 10 &&
                Controller1.Axis2.position(percent) > -10);
    } else if (Controller1.Axis2.position(percent) < -10) {
      if (Controller1.Axis2.position(percent) < -60) {
        flywheelSpeed = flywheelSpeed - 10;
      } else {
        flywheelSpeed = flywheelSpeed - 5;
