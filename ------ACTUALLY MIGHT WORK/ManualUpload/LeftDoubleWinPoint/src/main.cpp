...
// Drivetrain           drivetrain    17, 13, 15, 18, 11
...
void LeftStartDoubleWinPoint() {
  ...
  Drivetrain.turnToHeading(89, degrees);
...
int main() {
  ...
  while (true) {
    if(Drivetrain.heading() > 14 && Drivetrain.heading() < 15){
